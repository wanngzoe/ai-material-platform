...
export const tasks: TasksData = {
  前贴生成: [
    { id: "QG-0001", name: "前贴生成任务_1", type: "前贴生成", status: "已完成", createTime: "2026-03-20 10:30", endTime: "2026-03-20 10:45" },
    { id: "QG-0002", name: "前贴生成任务_2", type: "前贴生成", status: "处理中", createTime: "2026-03-20 11:00", endTime: "-" },
    { id: "QG-0003", name: "前贴生成任务_3", type: "前贴生成", status: "排队中", createTime: "2026-03-20 11:15", endTime: "-" },
    { id: "QG-0004", name: "前贴生成任务_4", type: "前贴生成", status: "已完成", createTime: "2026-03-19 14:30", endTime: "2026-03-19 14:50" },
    { id: "QG-0005", name: "前贴生成任务_5", type: "前贴生成", status: "失败", createTime: "2026-03-19 15:00", endTime: "2026-03-19 15:05" },
    { id: "QG-0006", name: "前贴生成任务_6", type: "前贴生成", status: "已完成", createTime: "2026-03-18 09:20", endTime: "2026-03-18 09:35" },
    { id: "QG-0007", name: "前贴生成任务_7", type: "前贴生成", status: "处理中", createTime: "2026-03-18 10:00", endTime: "-" },
    { id: "QG-0008", name: "前贴生成任务_8", type: "前贴生成", status: "已完成", createTime: "2026-03-17 16:30", endTime: "2026-03-17 16:45" },
    { id: "QG-0009", name: "前贴生成任务_9", type: "前贴生成", status: "排队中", createTime: "2026-03-17 17:00", endTime: "-" },
    { id: "QG-0010", name: "前贴生成任务_10", type: "前贴生成", status: "已完成", createTime: "2026-03-16 08:15", endTime: "2026-03-16 08:30" },
    { id: "QG-0011", name: "前贴生成任务_11", type: "前贴生成", status: "已完成", createTime: "2026-03-15 13:45", endTime: "2026-03-15 14:00" },
    { id: "QG-0012", name: "前贴生成任务_12", type: "前贴生成", status: "处理中", createTime: "2026-03-14 11:20", endTime: "-" },
    { id: "QG-0013", name: "前贴生成任务_13", type: "前贴生成", status: "已完成", createTime: "2026-03-13 15:30", endTime: "2026-03-13 15:45" },
    { id: "QG-0014", name: "前贴生成任务_14", type: "前贴生成", status: "失败", createTime: "2026-03-12 10:00", endTime: "2026-03-12 10:05" },
    { id: "QG-0015", name: "前贴生成任务_15", type: "前贴生成", status: "已完成", createTime: "2026-03-11 09:30", endTime: "2026-03-11 09:45" },
  ],
  素材拼接: [
    { id: "PJ-0001", name: "素材拼接任务_1", type: "素材拼接", status: "已完成", createTime: "2026-03-20 09:00", endTime: "2026-03-20 09:20" },
    { id: "PJ-0002", name: "素材拼接任务_2", type: "素材拼接", status: "处理中", createTime: "2026-03-20 10:30", endTime: "-" },
    { id: "PJ-0003", name: "素材拼接任务_3", type: "素材拼接", status: "排队中", createTime: "2026-03-19 14:00", endTime: "-" },
    { id: "PJ-0004", name: "素材拼接任务_4", type: "素材拼接", status: "已完成", createTime: "2026-03-19 16:30", endTime: "2026-03-19 16:50" },
    { id: "PJ-0005", name: "素材拼接任务_5", type: "素材拼接", status: "已完成", createTime: "2026-03-18 11:15", endTime: "2026-03-18 11:35" },
    { id: "PJ-0006", name: "素材拼接任务_6", type: "素材拼接", status: "失败", createTime: "2026-03-18 13:00", endTime: "2026-03-18 13:10" },
    { id: "PJ-0007", name: "素材拼接任务_7", type: "素材拼接", status: "已完成", createTime: "2026-03-17 08:45", endTime: "2026-03-17 09:05" },
    { id: "PJ-0008", name: "素材拼接任务_8", type: "素材拼接", status: "处理中", createTime: "2026-03-16 15:20", endTime: "-" },
    { id: "PJ-0009", name: "素材拼接任务_9", type: "素材拼接", status: "已完成", createTime: "2026-03-15 10:00", endTime: "2026-03-15 10:20" },
    { id: "PJ-0010", name: "素材拼接任务_10", type: "素材拼接", status: "已完成", createTime: "2026-03-14 14:30", endTime: "2026-03-14 14:50" },
  ],
};
